...
def main():
    ...
    # 파일 불러오기
    path = "training_2000.csv"
    df = pd.read_csv(path, encoding="cp949")
    data_X = df['reviewText'].values   # 문장 컬럼
    ...
    for e in range(0, epoch):
        ...
        writer.add_scalar("log_lm/train", avg_train_loss, e)
        ...
        writer.add_scalar("log_lm/valid", avg_eval_accuracy, e)
